...
exports.EdrProviderWrapper = exports.DEFAULT_COINBASE = void 0;
...
class EdrProviderWrapper extends events_1.EventEmitter {
    ...
    _node;
    _subscriptionConfig;
    _originalGenesisAccounts;
    _originalCacheDir;
    _originalChainOverrides;
    _failedStackTraces = 0;
    // temporarily added to make smock work with HH+EDR
    _callOverrideCallback;
    ...
    static async create(config, loggerConfig, tracingConfig) {
        ...
        // FLASH PATCH (scripts/apply-hardhat-fork-patch.js):
